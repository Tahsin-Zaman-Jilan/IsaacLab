...
class Se3Keyboard(DeviceBase):
    ...
    * lift (opt-in via :attr:`Se3KeyboardCfg.lift_term`): a 1D delta along a separate lift
      joint's axis (e.g. a prismatic base/mount joint), appended after the gripper term.
      Disabled by default; existing tasks are unaffected.
    ...
    def __init__(self, cfg: Se3KeyboardCfg):
        ...
        self._delta_lift = np.zeros(1)  # (z, lift joint)
    ...
    def _create_key_bindings(self):
        ...
        self._INPUT_KEY_MAPPING = {
            ...
            # lift-axis (separate lift joint), opt-in via cfg.lift_term
